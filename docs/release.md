...
- Android: APK release firmado con una clave persistente protegida por GitHub Secrets. `v0.3.0` conserva package name/certificado de las versiones anteriores y sube `versionCode` a 3. No publicar un APK debug.
