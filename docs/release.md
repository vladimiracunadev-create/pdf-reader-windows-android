...
- Android: APK release firmado con una clave persistente protegida por GitHub Secrets. `v0.3.1` conserva package name/certificado de las versiones anteriores y sube `versionCode` a 4. No publicar un APK debug.
