...
## Android
La selección usa el selector de archivos del sistema. El APK v0.3.0 no declara permisos: ni acceso amplio al almacenamiento ni `INTERNET`. CI abre los metadatos del APK ya compilado y falla si reaparece un permiso prohibido. `@capacitor/share` delega en la hoja del sistema sin añadir permiso de red a PDF Reader.
